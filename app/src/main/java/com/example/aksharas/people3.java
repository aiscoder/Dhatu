...
public class people3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sol = MediaPlayer.create(people3.this, R.raw.soldier);
        final MediaPlayer sol = MediaPlayer.create(this, R.raw.soldier);
        teach = MediaPlayer.create(people3.this, R.raw.teacher);
        final MediaPlayer teach = MediaPlayer.create(this, R.raw.teacher);
        doc = MediaPlayer.create(people3.this, R.raw.doctor);
        final MediaPlayer doc = MediaPlayer.create(this, R.raw.doctor);
        gode = MediaPlayer.create(people3.this, R.raw.lakshmi);
